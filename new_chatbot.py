...
class RAGChatbot:
    ...
    def _extract_text_with_headers(self):
        """Fixed PDF extraction with proper error handling"""
        try:
            with open(self.pdf_path, 'rb') as f:
                # Use pypdf.PdfReader with strict=False
            ...
            try:
                ...
                print(f"Successfully extracted text using PyMuPDF fallback")

            except ImportError:
                print("Install PyMuPDF for better PDF handling: pip install pymupdf")
                raise
